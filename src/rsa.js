...
var RSA = function() {
	...
	function biFromNumber(n){var t=new BigInt,i;for(t.isNeg=n<0,n=Math.abs(n),i=0;n> 0;) t.digits[i++]=n&maxDigitVal,n>>= biRadixBits;return t}
	...
	function digitToHex(n){var r=15,t="";for(i=0;i<4;++i) t+= hexToChar[n&r],n>>>= 4;return reverseStr(t)}
	function biToHex(n){for(var i="",r=biHighIndex(n),t=biHighIndex(n) ;t> -1;--t) i+= digitToHex(n.digits[t]);return i}
	function charToHex(n){var i=48,f=i+9,r=97,e=r+25,u=65,o=90,t;return t=n>=i&&n<=f?n-i:n>=u&&n<=o?10+n-u:n>=r&&n<=e?10+n-r:0}
	function hexToDigit(n){for(var i=0,r=Math.min(n.length,4),t=0;t<r;++t) i <<= 4,i |= charToHex(n.charCodeAt(t));return i}
	function biFromHex(n){for(var r=new BigInt,u=n.length,t=u,i=0;t> 0;t-= 4,++i) r.digits[i]=hexToDigit(n.substr(Math.max(t-4,0),Math.min(t,4)));return r}
	...
	function biToBytes(n){for(var i="",t=biHighIndex(n) ;t> -1;--t) i+= digitToBytes(n.digits[t]);return i}
	function digitToBytes(n){var i=String.fromCharCode(n&255),t;return n>>>= 8,t=String.fromCharCode(n&255),t+i}
	function biDump(n){return (n.isNeg?"-":"")+n.digits.join(" ")}
	function biAdd(n,t){var r,u,f,i;if(n.isNeg!=t.isNeg) t.isNeg=!t.isNeg,r=biSubtract(n,t),t.isNeg=!t.isNeg;else{for(r=new BigInt,u=0,i=0;i<n.digits.length;++i) f=n.digits[i]+t.digits[i]+u,r.digits[i]=f&65535,u=Number(f>=biRadix);r.isNeg=n.isNeg}return r}
	function biSubtract(n,t){var r,f,u,i;if(n.isNeg!=t.isNeg) t.isNeg=!t.isNeg,r=biAdd(n,t),t.isNeg=!t.isNeg;else{for(r=new BigInt,u=0,i=0;i<n.digits.length;++i) f=n.digits[i]-t.digits[i]+u,r.digits[i]=f&65535,r.digits[i]<0&&(r.digits[i]+= biRadix),u=0-Number(f<0);if(u==-1){for(u=0,i=0;i<n.digits.length;++i) f=0-r.digits[i]+u,r.digits[i]=f&65535,r.digits[i]<0&&(r.digits[i]+= biRadix),u=0-Number(f<0);r.isNeg=!n.isNeg}else r.isNeg=n.isNeg}return r}
	...
	function biMultiply(n,t){for(var r=new BigInt,u,o=biHighIndex(n),s=biHighIndex(t),h,e,f,i=0;i<=s;++i){for(u=0,f=i,j=0;j<=o;++j,++f) e=r.digits[f]+n.digits[j]*t.digits[i]+u,r.digits[f]=e&maxDigitVal,u=e>>> biRadixBits;r.digits[i+o+1]=u}return r.isNeg=n.isNeg!=t.isNeg,r}
	...
	function RSAKeyPair(n,t,i,r){this.e=biFromHex(n),this.d=biFromHex(t),this.m=biFromHex(i),this.chunkSize=typeof r!="number"?2*biHighIndex(this.m):r/8,this.radix=16,this.barrett=new BarrettMu(this.m)}
	function encryptString(n,t,i,r){var o=[],s=t.length,u,f,l,e,v,c,p,w="",h,a,y;for(e=typeof i=="string"?i==RSAAPP.NoPadding?1:i==RSAAPP.PKCS1Padding?2:0:0,v=typeof r=="string"&&r==RSAAPP.RawEncoding?1:0,e==1?s> n.chunkSize&&(s=n.chunkSize):e==2&&s> n.chunkSize-11&&(s=n.chunkSize-11),u=0,f=e==2?s-1:n.chunkSize-1;u<s;) e?o[f]=t.charCodeAt(u):o[u]=t.charCodeAt(u),u++,f--;for(e==1&&(u=0),f=n.chunkSize-s % n.chunkSize;f> 0;){if(e==2){for(c=Math.floor(Math.random()*256) ;!c;) c=Math.floor(Math.random()*256);o[u]=c}else o[u]=0;u++,f--}for(e==2&&(o[s]=0,o[n.chunkSize-2]=2,o[n.chunkSize-1]=0),p=o.length,u=0;u<p;u+= n.chunkSize){for(h=new BigInt,f=0,l=u;l<u+n.chunkSize;++f) h.digits[f]=o[l++],h.digits[f]+= o[l++] << 8;a=n.barrett.powMod(h,n.e),y=v==1?biToBytes(a):n.radix==16?biToHex(a):biToString(a,n.radix),w+= y}return w}
	function decryptString(n,t){for(var e=t.split(" "),f,u,o,i="",r=0;r<e.length;++r) for(o=n.radix==16?biFromHex(e[r]):biFromString(e[r],n.radix),f=n.barrett.powMod(o,n.d),u=0;u<=biHighIndex(f) ;++u) i+= String.fromCharCode(f.digits[u]&255,f.digits[u]>> 8);return i.charCodeAt(i.length-1)==0&&(i=i.substring(0,i.length-1)),i};
